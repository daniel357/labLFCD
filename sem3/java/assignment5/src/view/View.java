...
public class View {
    ...
    private void runProgram1() throws ExpressionEvaluationException, ADTException, StatementExecutionException, IOException, InterruptedException {
    ...
    private void runProgram2() throws ExpressionEvaluationException, ADTException, StatementExecutionException, IOException, InterruptedException {
    ...
    private void runProgram3() throws ExpressionEvaluationException, ADTException, StatementExecutionException, IOException, InterruptedException {
    ...
    private void runStatement(IStatement statement) throws ExpressionEvaluationException, ADTException, StatementExecutionException, IOException, InterruptedException {
        ...
        ProgramState state = new ProgramState(executionStack, symbolTable, output, fileTable, new MyHeap(),statement);
